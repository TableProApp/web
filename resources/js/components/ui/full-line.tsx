...
export function FullLine({ className }: { className?: string }) {
    return (
        <div
            className={cn('-ml-[100vw] h-px w-[200vw] bg-gray-950/5 dark:bg-white/10', className)}
            aria-hidden="true"
        />
    );
}
...
export function AccentLine() {
    return (
        <div className="relative -ml-[100vw] h-px w-[200vw] bg-gray-950/5 dark:bg-white/10" aria-hidden="true">
