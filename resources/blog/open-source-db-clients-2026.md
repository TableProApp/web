...
Native macOS app written in Swift and AppKit. 18 databases through a plugin architecture (MySQL, Postgres, MongoDB, Redis, ClickHouse, BigQuery, DynamoDB, Cloudflare D1, Turso, etc.). Free, open source, with paid features (license server, advanced AI usage).
